...
const Carousel = () => {
  ...
  const cards = [
    { id: 1, profile: 'fas fa-robot', title: 'Uni Recognition', content: 'Content 1', technology1: 'C++', technology2: 'Flask', technology3: 'Postgress', technologyplus: '+', img: './static/img/recog.png', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis imperdiet tempor placerat. Mauris vel ipsum et est iaculis fringilla. Vestibulum aliquet consectetur aliquam. Sed arcu lectus, dapibus quis enim quis, molestie convallis urna.' },
    { id: 2, profile: 'fas fa-gamepad', title: 'Laser Killer', content: 'Content 2', technology1: 'JS', technology2: 'HTML', technology3: 'CSS', technologyplus: '+', img: './static/img/laser.png', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis imperdiet tempor placerat. Mauris vel ipsum et est iaculis fringilla. Vestibulum aliquet consectetur aliquam. Sed arcu lectus, dapibus quis enim quis, molestie convallis urna.' },
    { id: 3, profile: 'far fa-comments', title: 'Pandora', content: 'Content 3', technology1: 'JS', technology2: 'HTML', technology3: 'CSS', technologyplus: '+', img: './static/img/pandora.png', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis imperdiet tempor placerat. Mauris vel ipsum et est iaculis fringilla. Vestibulum aliquet consectetur aliquam. Sed arcu lectus, dapibus quis enim quis, molestie convallis urna.' },
    ...
    { id: 5, profile: 'fas fa-atom', title: 'Piveta System', content: 'Content 4', technology1: 'JS', technology2: 'HTML', technology3: 'CSS', technologyplus: '+', img: './static/img/piveta.png', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis imperdiet tempor placerat. Mauris vel ipsum et est iaculis fringilla. Vestibulum aliquet consectetur aliquam. Sed arcu lectus, dapibus quis enim quis, molestie convallis urna.' },
