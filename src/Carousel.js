...
const Carousel = () => {
  ...
  const cards = [
    ...
    { id: 6, profile: 'fas fa-user', title: 'Login Page With Session', content: 'Content 6', technology1: 'React', technology2: 'Tailwind', technology3: 'JWT', technologyplus: '+', img: './static/img/interfocus.png', text: 'LoginPage Secure Access is a project designed to provide a seamless and secure authentication experience. Featuring multiple sessions, it allows users to log in from different devices while maintaining data integrity and security.' },

    { id: 7, profile: 'fas fa-robot', title: 'Shipping Automation', content: 'Content 7', technology1: 'Pyhton', technology2: 'Selenium', technology3: 'Tkinter', technologyplus: '+', img: './static/img/leadsense.png', text: 'A Python project that automates repetitive tasks using Selenium for web interaction and Tkinter for an intuitive interface. It streamlines workflows, enhances efficiency, and minimizes manual effort, making complex processes easier to manage.' },
